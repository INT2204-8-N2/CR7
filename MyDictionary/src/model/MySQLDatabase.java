...
public class MySQLDatabase {
	...
	public int insertWord(String word,String definition) throws SQLException {
		 connectDatabase = DriverManager.getConnection(connectionURL, userName,password);
		Statement stmt = connectDatabase.createStatement();
	...
	public int detetetWord(String word) throws SQLException {
		 connectDatabase = DriverManager.getConnection(connectionURL, userName,password);
		Statement stmt = connectDatabase.createStatement();
                System.out.println("DELETE FROM tbl_edict WHERE word='"+word+"';");
        ...
        public int updatetID(String word, String col,String change) throws SQLException {
		connectDatabase = DriverManager.getConnection(connectionURL, userName,password);
		Statement stmt = connectDatabase.createStatement();
            System.out.println("UPDATE tbl_edict SET "+ col+" = '"+change+"'WHERE word='"+word+"'"+"';");
	    int rs = stmt.executeUpdate(" UPDATE tbl_edict SET "+ col+" = '"+change+"'WHERE word='"+word+"';");// cau lenh try van 
	    System.out.println(rs);
	      connectDatabase.close();
              return rs;
	}
